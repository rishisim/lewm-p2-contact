#!/usr/bin/env python3
"""Materialize and seal the complete cycle-002 prospective protocol."""
...
def build_cohort() -> dict[str, Any]:
        ...
        roles[role] = [
            {
                "role": role,
                "slot": slot,
                "episode_id": f"c002-{role}-{slot:03d}",
    ...
    ledger = {
        ...
        **analysis_seeds,
        ...
        "freshness": "all cycle-002 smoke and prospective episode identifiers and all three RNG streams are disjoint from every recorded prior run and prior V5-readiness-cycle identifier",
...
def main() -> None:
    ...
    if seal_path.exists():
        raise RuntimeError("cycle 002 is already sealed")
    ...
    protocol = {
        "schema_version": 1,
        "study": "cycle 002 PlanOracle scale-valid-simultaneous prospective discovery",
        "not_v5": True,
    ...
    preregistration = f"""# Preregistration: LeWM V5-readiness cycle 002 scale-valid simultaneous inference
...
"""
    ...
    seal = {
        "schema_version": 1,
        "status": "frozen_before_any_cycle_002_smoke_or_prospective_episode",
