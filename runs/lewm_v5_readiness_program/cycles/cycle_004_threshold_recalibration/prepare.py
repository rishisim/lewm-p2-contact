#!/usr/bin/env python3
"""Materialize and seal the complete cycle-004 prospective protocol."""
...
def build_cohort() -> dict[str, Any]:
        ...
        roles[role] = [
            {
                "role": role,
                "slot": slot,
                "episode_id": f"c004-{role}-{slot:03d}",
    ...
    analysis_seeds = {
        "bootstrap_seed": 2_005_999_991,
        "histogram_seed": 2_005_888_881,
        "seeded_mixture_seed": 2_005_777_771,
    }
    new_numbers = {
        item[key]
    ...
    ledger = {
        ...
        **analysis_seeds,
        ...
        "freshness": "all cycle-004 smoke and prospective episode identifiers and all three RNG streams are disjoint from every recorded prior run and prior V5-readiness-cycle identifier",
...
def main() -> None:
    ...
    if seal_path.exists():
        raise RuntimeError("cycle 004 is already sealed")
    ...
    required_qualification = {
        ...
        "audit/threshold_recalibration_qualification.json": "passed",
    ...
    protocol = {
        "schema_version": 1,
        "study": "cycle 004 PlanOracle threshold-recalibrated prospective discovery",
        "not_v5": True,
        "frozen_candidate": "minimax_dual_linear-r0.01-q0.85-threshold-0.2719204773217412",
        "threshold": THRESHOLD,
...
"""
    ...
    atomic_json(
        ROOT / "expected_artifact_roles.json",
        {
            ...
            "required_before_smoke": [
                ...
                "development/selected_threshold.json",
                "audit/threshold_recalibration_qualification.json",
    ...
    generated_normative = [
        ...
        ROOT / "development/threshold_selection_protocol.json",
        ROOT / "development/threshold_selection_result.json",
        ROOT / "development/cycle_001_cycle_003_diagnosis.json",
        ROOT / "development/selected_threshold.json",
        ...
        ROOT / "audit/threshold_recalibration_qualification.json",
    ...
    seal = {
        "schema_version": 1,
        "status": "frozen_before_any_cycle_004_smoke_or_prospective_episode",
