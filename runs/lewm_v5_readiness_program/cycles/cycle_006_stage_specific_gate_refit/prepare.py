...
def main() -> None:
    ...
    if seal_path.exists():
        raise RuntimeError("cycle 006 prospective package is already sealed")
    ...
    expected_roles = {
        "schema_version": 1,
        "fit": "240 fresh episodes used only for feature normalization and ridge head fitting",
        "selection": "120 disjoint fresh episodes used once for nine-candidate selection; no refit",
    ...
    seal = {
        "schema_version": 1,
        "status": "frozen_before_any_cycle_006_smoke_or_prospective_episode",
        ...
        "fit_episodes_at_seal": 240,
        "selection_episodes_at_seal": 120,
