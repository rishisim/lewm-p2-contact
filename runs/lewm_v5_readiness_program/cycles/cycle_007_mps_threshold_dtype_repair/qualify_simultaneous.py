...
def main() -> None:
    ...
    diagnosis = read_json(
        ROOT.parent
        / "cycle_002_scale_valid_simultaneous/development/cycle_001_consumed_diagnosis.json"
    )
    ...
    checks = {
        ...
        "scale_valid_method_was_fixed_before_cycle_006": diagnosis["bounded_change"][
            "candidate_count"
        ]
        == 1,
        ...
        "new_design_has_no_sequential_expansion": read_json(ROOT / "protocol.json")[
            "prospective"
