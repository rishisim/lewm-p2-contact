...
def verify_role_permission(role: str) -> dict[str, Any]:
    if role not in ("smoke", "prospective"):
        raise RuntimeError("cycle 007 carries a frozen cycle-006 gate and forbids refit/reselection")
    return verify_pre_data()
...
def main() -> None:
    ...
    generate_parser.add_argument("role", choices=("smoke", "prospective"))
