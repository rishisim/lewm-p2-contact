# LeWM contact-free adaptive-computation V5 preregistration — package v001
...
All normative code, frozen objects, ledgers, mappings, source hashes, and this preregistration are sealed before package smoke. A smoke failure invalidates v001; it may not be patched in place. Package construction and smoke generate zero V5 confirmation outcomes.
