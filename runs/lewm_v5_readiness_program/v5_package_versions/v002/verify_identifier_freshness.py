#!/usr/bin/env python3
"""Independently recompute v002 identifier freshness against all prior records."""
...
def main() -> None:
    ...
    result = {
        ...
        "v002_numeric_set_sha256": digest(numbers),
        "v002_string_set_sha256": digest(set(ids)),
