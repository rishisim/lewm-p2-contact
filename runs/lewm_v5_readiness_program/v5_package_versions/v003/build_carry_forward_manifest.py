#!/usr/bin/env python3
"""Materialize exact v001-to-v003 scientific carry-forward evidence."""
...
def main() -> None:
    ...
    module_records = {
        relative: {
            ...
            "v003_normalized_ast_sha256": ast_hash(ROOT / relative, normalized=True),
    ...
    runner_records = {
        name: {
            ...
            "v003_ast_sha256": function_hash(ROOT / "runner.py", name),
    ...
    v003_constants = constants(ROOT / "cycle_common.py")
    checks = {
        ...
        "scientific_constants_identical": v001_constants == v003_constants
    ...
    payload = {
        ...
        "scientific_constants": v003_constants,
        "checks": checks,
