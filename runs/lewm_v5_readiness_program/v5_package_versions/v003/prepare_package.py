#!/usr/bin/env python3
"""Materialize and seal complete V5 package v003 before excluded smoke."""
...
def main() -> None:
    ...
    if seal_path.exists():
        raise RuntimeError("V5 package v003 is already sealed")
    no_outcome_data()
    ...
    seal = {
        "schema_version": 1,
        "created_unix_ns": time.time_ns(),
        "status": "frozen_before_any_v003_package_smoke_or_v5_confirmation_episode",
