#!/usr/bin/env python3
"""Independently recompute v003 identifier freshness against all prior records."""
...
def main() -> None:
    ...
    result = {
        ...
        "v003_numeric_set_sha256": digest(numbers),
        "v003_string_set_sha256": digest(set(ids)),
