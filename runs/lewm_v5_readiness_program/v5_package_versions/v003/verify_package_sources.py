...
SEED_REMAP = {
    2_621_999_991: 2_051_999_991,
    2_621_888_881: 2_051_888_881,
    2_621_777_771: 2_051_777_771,
}
...
def verify() -> dict:
    ...
    version_checks = {
        relative: (ROOT / relative).read_text().replace("v003", "v001")
    ...
    seed_checks = {
        "analysis_bootstrap": "BOOTSTRAP_SEED = 2_621_999_991" in analysis,
        "analysis_histogram": "HISTOGRAM_SEED = 2_621_888_881" in analysis,
        "analysis_mixture": "SEEDED_MIXTURE_SEED = 2_621_777_771" in analysis,
        "independent_bootstrap": "np.random.default_rng(2_621_999_991)" in independent,
        "independent_histogram": "np.random.default_rng(2_621_888_881)" in independent,
        "independent_mixture": "np.random.default_rng(2_621_777_771)" in independent,
    }
