#!/usr/bin/env python3
"""Read-only verifier for the immutable v003 pre-V5 seal."""
...
def verify() -> dict[str, Any]:
    ...
    checks = {
        ...
        == "frozen_before_any_v003_package_smoke_or_v5_confirmation_episode",
        "package_version": seal.get("package_version") == "v003",
