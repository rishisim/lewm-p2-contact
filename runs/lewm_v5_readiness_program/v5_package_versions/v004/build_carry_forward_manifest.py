#!/usr/bin/env python3
"""Materialize exact v001-to-v004 scientific carry-forward evidence."""
...
SEED_REMAP = {
    2_831_999_991: 2_051_999_991,
    2_831_888_881: 2_051_888_881,
    2_831_777_771: 2_051_777_771,
}
...
def main() -> None:
    ...
    module_records = {
        relative: {
            ...
            "v004_normalized_ast_sha256": ast_hash(ROOT / relative, normalized=True),
    ...
    runner_records = {
        name: {
            ...
            "v004_ast_sha256": function_hash(ROOT / "runner.py", name),
    ...
    v004_constants = constants(ROOT / "cycle_common.py")
    checks = {
        ...
        "scientific_constants_identical": v001_constants == v004_constants
    ...
    payload = {
        ...
        "scientific_constants": v004_constants,
        "checks": checks,
        ...
        "allowed_changes": [
            ...
            "float64 machine-precision-scaled tolerance in the synthetic-only inference qualification harness",
        ],
