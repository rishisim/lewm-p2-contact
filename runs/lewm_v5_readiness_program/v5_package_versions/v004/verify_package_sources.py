...
def verify() -> dict:
    ...
    version_checks = {
        relative: (ROOT / relative).read_text().replace("v004", "v001")
    ...
    seed_checks = {
        "analysis_bootstrap": "BOOTSTRAP_SEED = 2_831_999_991" in analysis,
        "analysis_histogram": "HISTOGRAM_SEED = 2_831_888_881" in analysis,
        "analysis_mixture": "SEEDED_MIXTURE_SEED = 2_831_777_771" in analysis,
        "independent_bootstrap": "np.random.default_rng(2_831_999_991)" in independent,
        "independent_histogram": "np.random.default_rng(2_831_888_881)" in independent,
        "independent_mixture": "np.random.default_rng(2_831_777_771)" in independent,
    }
